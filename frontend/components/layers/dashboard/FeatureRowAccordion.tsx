...
export const FEATURE_BENCHMARKS: Record<string, FeatureBenchmark> = {
  ...
  // NOTE: Engineered features (monthly burden, stability score, credit to income ratio, 
  // duration risk, credit risk ratio) are intentionally EXCLUDED from benchmarks.
  // They should only show text explanations, not distribution lines.
}
